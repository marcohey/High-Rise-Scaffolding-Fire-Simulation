...
export const DEFAULT_PARAMS: AdvancedParams = {
  IGNITION_TEMP_BAMBOO,
  IGNITION_TEMP_STYROFOAM,
  MELT_TEMP_STYROFOAM,
  IGNITION_TEMP_NETTING,
  IGNITION_TEMP_NETTING_FR,
  FAILURE_TEMP_METAL,
  SOFTENING_TEMP_METAL,
  ...
  HEAT_OUTPUT_BAMBOO,
  HEAT_OUTPUT_STYROFOAM,
  HEAT_OUTPUT_NETTING,
  HEAT_OUTPUT_NETTING_FR,
  
  CONDUCTIVITY_METAL,
  HEAT_CAPACITY_METAL,
  CONDUCTIVITY_BAMBOO,
  HEAT_CAPACITY_BAMBOO,
  VERTICAL_SPREAD_FACTOR,
  COOLING_RATE,
  COOLING_RATE_WET,
  METAL_COOLING_BONUS,
  
  NETTING_FLASHOVER_CHANCE,
  NETTING_FLASHOVER_CHANCE_FR,
  DRIP_CHANCE_STYROFOAM,
  DRIP_CHANCE_NETTING,
  
  BAMBOO_IGNITION_CHANCE_DRY,
  BAMBOO_IGNITION_CHANCE_WET,
  NETTING_IGNITION_CHANCE_DRY,
  NETTING_IGNITION_CHANCE_WET
};
